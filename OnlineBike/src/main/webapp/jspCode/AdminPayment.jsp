...
<%
 ...
 try{
	...
	out.println("</table>");
	pst.execute(); 	
	out.println("<h2 style='color:black ;font-size:20px;'><b>Give Approval for this Id <a href='../jspCode/paymentapproval.jsp'>User Id</a></b></h2>");
	
	out.println("<h2 style='color:black ;font-size:20px;'><b>list of  Approval id's<a href='../jspCode/paymentDetails.jsp'>  click here</a></b></h2>");
	rs.close();
	pst.close();
 }
catch(Exception e){
