...
<%
 ...
 try{
	...
	ResultSet rs=pst.executeQuery();
	out.println("<center><h3  style='color:black ;font-size:25px;'>Service engineer Details</h3></center>");
	out.println("<table border = 4 bgcolor=lightGray style='height: 80%; width: 100% ;'>");
	out.println("<thead><th>User ID</th><th>Name</th><th>Email ID</th><th>Phone No.</th><th>Adhaar No</th><th>Address</th><th>City</th><th>State</th><th>Experience</th><th>Requiment</th></thead>");
	...
	out.print("<td>  "+rs.getString("requirement")+"  "+"</td></tr>");
	}
