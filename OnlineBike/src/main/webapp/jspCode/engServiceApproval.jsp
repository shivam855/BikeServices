...
<%
 ...
 try{
	...
	out.println("</table>");
	pst.execute(); 	
	out.println("<h3><b>Give Approval for this Tracking Id <a href='../jspCode/ApprovalbyEng.jsp'>Track Id</a></b></h3>");		
	rs.close();
	pst.close();
 }
catch(Exception e){
...
%>
<br><br><center><a class=low href="../jspCode/engineerBase.jsp"> Back to Engineer Portal</a></center>
</body>
</html>