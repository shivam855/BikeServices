...
<%
 try{
	...
	out.println("</table>");
	pst.execute(); 	
	out.println("<h3><b>Give Approval for this Id <a href='../jspCode/ApprovalForCustomer.jsp'>User Id</a></b></h3>");
	out.println("<h3><b>Check all the Approval Services<a href='../jspCode/approvalServices.jsp'> click here</a></b></h3>");			
	out.println("<h3><b>Check all the details of customer<a href='../jspCode/customerDetails.jsp'> click here</a></b></h3>");		
	rs.close();
	pst.close();
 }
catch(Exception e){
